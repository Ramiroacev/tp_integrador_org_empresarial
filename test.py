from modulos.auxiliares import pedir_entero, inicializar_archivos, buscar_empleado, obtener_licencia, guardar_solicitud, buscar_solicitud, cambiar_estado_solicitud
